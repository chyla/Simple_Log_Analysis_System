...
urlpatterns = [
    ...
    url(r'^configure_anomaly_detection_select_data_range_save_settings$', views.configure_anomaly_detection_select_data_range_save_settings, name='configure_anomaly_detection_select_data_range_save_settings'),
