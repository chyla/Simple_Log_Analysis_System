...
::bash::domain::type::DailyUserStatistics Scripts::GetDailyUserStatisticsWithoutLearningSetForAgent(::database::type::RowId agent_name_id,
                                                                                                    const ::type::Date &begin_date,
                                                                                                    const ::type::Date &end_date) {
  BOOST_LOG_TRIVIAL(debug) << "bash::domain::Scripts::GetDailyUserStatisticsWithoutLearningSetForAgent: Function call";

  auto date_range_ids = general_database_functions_->GetDateRangeIds(begin_date, end_date);

  auto raw_statistics = database_functions_->GetDailyUserStatisticsWithoutLearningSetForAgent(agent_name_id, date_range_ids);
